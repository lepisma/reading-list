...
For many it might just be a confirming nod to what they know about Big data in general, but is a good read nevertheless.<br/><br/>Overall, it ties "data science" with its responsibilities. Responsibilities which demands greater care and openness than assumed in the present unconstrained Big data buzz.
...
There is a different complexion in a dying person's writing. You don't have to like it or hate it. Its honest, brutal and beautiful.
...
It could have been helped by a bit more deeper storyline and 'theorics', considering the number of pages (~1000).<br/>The kind of topics it touched, it could have been perfect. But sometimes it bloats out.
...
It wasn't in my high priority to-read list, but I started and didn't stop till it was over.<br/>Exactly the way I wanted the piracy story to be told.
